...
-    Select “Download R 3.5.2 for Windows”
-    Open the downloaded file (R-3.5.2-win.exe)
...
-    Scroll down and select “RStudio 1.1.463 - Windows Vista/7/8/10”
-    Open the downloaded file (RStudio-1.1.463.exe)
-    Select “Run” if prompted
-    Follow the set-up instructions (if unsure of something, leave the default settings)
