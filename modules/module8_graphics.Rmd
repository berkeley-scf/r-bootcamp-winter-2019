...
6) Plot life expectancy versus gdpPercap. Now plot so that different continents are in different colors. Use `scale_x_continuous()` to set the x-axis limits to be in the range from 0 to 50000.
