...
gapminder <- read.csv(file.path('..', 'data', 'gapminder-FiveYearData.csv'), stringsAsFactors = FALSE)
```
...
wealthy <- gm2007$gdpPercap > 40000
healthy <- gm2007$lifeExp > 75

head(wealthy)
table(wealthy)

# note the vectorized boolean arithmetic
gm2007[wealthy & healthy, ]
gm2007[wealthy | healthy, ]
gm2007[wealthy & !healthy, ]
...
countries <- as.character(gm2007$country)
...
5) Consider the first row of the gapminder dataset, which has Afghanistan for 1952. How do I create a string "Afghanistan-1952" using `gapminder$country[1]` and `gapminder$year[1]`? 
